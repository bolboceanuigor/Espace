...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { label: 'Suport', href: '/superadmin/support-mode', icon: 'messageCircle', allowedRoles: ['SUPER_ADMIN'], mobileVisible: false, moreMenu: false },
  { label: 'Setări', href: '/superadmin/settings', icon: 'settings', allowedRoles: ['SUPER_ADMIN'], mobileVisible: false, moreMenu: false },
  ...
  { label: 'Mesaje', href: '/admin/chat', icon: 'messageCircle', allowedRoles: ['ADMIN'], mobileVisible: true, moreMenu: false },
