...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { label: 'Connect', href: '/admin/connect', icon: 'messageCircle', allowedRoles: ['ADMIN'], requiredModule: 'requests', mobileVisible: false, moreMenu: true },
  ...
  { label: 'Mesaje', href: '/resident/connect', icon: 'messageCircle', allowedRoles: ['RESIDENT'], mobileVisible: true, moreMenu: false },
