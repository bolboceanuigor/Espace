...
export default function ResidentConnectPage({ searchParams }: { searchParams?: PageSearchParams }) {
  return <ConnectWorkspace mode="resident" prefill={connectPrefill(searchParams)} />;
}
