...
export default function ResidentBottomNav({ unpaidCount = 0 }: { unpaidCount?: number }) {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border/80 bg-card/96 pb-[env(safe-area-inset-bottom)] shadow-[0_-14px_34px_-30px_rgba(21,62,59,0.45)] backdrop-blur-xl md:hidden">
