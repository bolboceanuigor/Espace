  ...
  async getMePayload(userId: string) {
    ...
    return {
      ...
      prefs: {
        ...
        calendarZoom: preference?.calendarZoom ?? 'md',
        calendarStatusFilter: preference?.calendarStatusFilter ?? 'all',
        calendarGroupId: preference?.calendarGroupId ?? null,
  ...
  async updateMyPreferences(userId: string, dto: UpdatePreferencesDto) {
    ...
    return this.prisma.userPreference.upsert({
      ...
      create: {
        ...
        calendarZoom: dto.calendarZoom ?? 'md',
        calendarStatusFilter: dto.calendarStatusFilter ?? 'all',
        calendarGroupId: dto.calendarGroupId ?? null,
        welcomeDismissed: dto.welcomeDismissed ?? false,
      },
      update: {
        ...(dto.locale !== undefined ? { locale: dto.locale } : {}),
        ...(dto.sidebarLabels !== undefined ? { sidebarLabels: dto.sidebarLabels } : {}),
        ...(dto.calendarZoom !== undefined ? { calendarZoom: dto.calendarZoom } : {}),
        ...(dto.calendarStatusFilter !== undefined
          ? { calendarStatusFilter: dto.calendarStatusFilter }
          : {}),
        ...(dto.calendarGroupId !== undefined ? { calendarGroupId: dto.calendarGroupId || null } : {}),
