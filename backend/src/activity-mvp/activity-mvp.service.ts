...
export type MvpActivityType =
  ...
  | 'RESIDENT_METER_READING_SUBMITTED'
  | 'RESIDENT_METER_READING_CANCELLED'
  | 'RESIDENT_METER_READING_APPROVED'
  | 'RESIDENT_METER_READING_REJECTED'
  | 'RESIDENT_METER_READING_BULK_APPROVED'
  | 'BILLING_PERIOD_CREATED'
  | 'BILLING_TARIFFS_UPDATED'
  | 'BILLING_DRAFTS_GENERATED'
  | 'BILLING_DRAFTS_RECALCULATED'
  | 'BILLING_PERIOD_APPROVED'
  | 'BILLING_DRAFTS_DELETED'
  | 'INVOICE_DRAFT_UPDATED'
  | 'INVOICE_UPDATED'
  | 'INVOICE_PUBLISHED'
  | 'INVOICE_BULK_PUBLISHED'
  | 'INVOICE_UNPUBLISHED'
  | 'RESIDENT_INVOICE_VIEWED'
  | 'PAYMENT_INTENT_PLACEHOLDER_CREATED'
  | 'PAYMENT_INTENT_PLACEHOLDER_CANCELLED'
  | 'PAYMENT_PROOF_SUBMITTED'
  | 'PAYMENT_PROOF_CANCELLED'
  | 'PAYMENT_PROOF_REVIEW_STARTED'
  | 'PAYMENT_PROOF_ACCEPTED'
  | 'PAYMENT_PROOF_PARTIALLY_ACCEPTED'
  | 'PAYMENT_PROOF_REJECTED'
  | 'PAYMENT_CREATED_MANUAL'
  | 'INVOICE_PAYMENT_STATUS_UPDATED'
  | 'PAYMENT_MANUAL_CREATED'
  | 'PAYMENT_UPDATED'
  | 'PAYMENT_REVERSED'
  | 'INVOICE_PAYMENT_STATUS_RECALCULATED'
  | 'APARTMENT_BALANCE_RECALCULATED'
  | 'RECONCILIATION_RUN'
  | 'INVOICE_CREATED'
  | 'PAYMENT_REGISTERED'
  | 'ISSUE_CREATED'
  ...
  | 'SERVICE_TICKET_COMMENT_ADDED'
  | 'SERVICE_TICKET_INTERNAL_NOTE_ADDED'
  | 'SERVICE_TICKET_RESOLVED'
  | 'SERVICE_TICKET_CLOSED'
  | 'SERVICE_TICKET_REOPENED'
  | 'SERVICE_TICKET_CANCELLED'
