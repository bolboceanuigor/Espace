...
CREATE TYPE "ClientRetentionEventType" AS ENUM ('CHURN_RISK_DETECTED', 'CHURN_RISK_STATUS_CHANGED', 'CHURN_RISK_ASSIGNED', 'CHURN_RISK_SAVED', 'CHURN_RISK_LOST', 'RENEWAL_CREATED', 'RENEWAL_STATUS_CHANGED', 'RENEWAL_COMPLETED', 'RETENTION_PLAN_CREATED', 'RETENTION_ACTION_COMPLETED', 'RETENTION_NOTE_ADDED', 'RETENTION_TASK_CREATED', 'RETENTION_FOLLOW_UP_CREATED', 'CLIENT_CONTACT_RECORDED', 'OUTCOME_SET');
